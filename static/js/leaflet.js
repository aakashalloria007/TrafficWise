...
!function (t, i) {
    ...
    var Q = document.documentElement.style, tt = "ActiveXObject" in window, it = tt && !document.addEventListener,
        ...
        at = ot && kt ("Google") && rt < 537 && !("AudioNode" in window), ht = !!window.opera,
        ut = !et && kt ("chrome"), lt = kt ("gecko") && !nt && !ht && !tt, ct = !ut && kt ("safari"),
        _t = kt ("phantom"), dt = "OTransition" in Q, pt = 0 === navigator.platform.indexOf ("Win"),
        mt = tt && "transition" in Q, ft = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !st,
        gt = "MozPerspective" in Q, vt = !window.L_DISABLE_3D && (mt || ft || gt) && !dt && !_t,
    ...
    var qi = {
        ...
        flyTo: function (s, r, t) {
            ...
            var l = Math.max (i.x, i.y), n = l * this.getZoomScale (u, r), c = h.distanceTo (a) || 1, _ = 1.42,
                o = _ * _;
    ...
    var ve, ye = {clipPolygon: ge}, xe = {
        ...
        }, Pe = {LonLat: xe, Mercator: we, SphericalMercator: V}, Le = h ({}, F, {
            code: "EPSG:3395",
            projection: we,
    ...
    ke.include (Ge), Ie.include (Ge), Ae.include (Ge), Oe.include ({
        ...
        toGeoJSON: function (t) {
            var i = !pe (this._latlngs), e = i && !pe (this._latlngs[0]),
